        ...
        <div class="row justify-content-center mb-4 fw-bold">
            ...
            <div class="col-md-3 text-center">
                ...
                <select id="filter" class="form-control" onchange="window.location.href=this.options[this.selectedIndex].value;">
                    ...
                    <option value="{{ route('treatments.GetSpaMassagesTreatmentsAsc') }}" class="text-center">Low to High</option>
                    <option value="{{ route('treatments.GetSpaMassagesTreatmentsDesc') }}" class="text-center" selected>High to Low</option>
                </select>
            </div>
        </div>
    </div>
