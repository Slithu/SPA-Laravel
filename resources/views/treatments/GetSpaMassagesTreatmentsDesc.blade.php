        ...
        <div class="row justify-content-center mb-4 fw-bold">
            <div class="col-md-3 text-center">
                ...
                <select id="filter" class="form-control" onchange="window.location.href=this.options[this.selectedIndex].value;">
                    ...
                    <option value="{{ route('treatments.GetSpaMassagesTreatments') }}" selected>SPA Massages</option>
            ...
            <div class="col-md-3 text-center">
                ...
                <select id="filter" class="form-control" onchange="window.location.href=this.options[this.selectedIndex].value;">
                    ...
                    <option value="{{ route('treatments.GetSpaMassagesTreatmentsAsc') }}">Low to High</option>
                    <option value="{{ route('treatments.GetSpaMassagesTreatmentsDesc') }}" selected>High to Low</option>
                </select>
            </div>
        </div>
    </div>
