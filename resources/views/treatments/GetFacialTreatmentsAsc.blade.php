        ...
        <div class="row justify-content-center mb-4 fw-bold">
            <div class="col-md-3 text-center">
                ...
                <select id="filter" class="form-control" onchange="window.location.href=this.options[this.selectedIndex].value;">
                    ...
                    <option value="{{ route('treatments.GetFacialTreatments') }}" class="text-center" selected>Facial Treatments</option>
            ...
            <div class="col-md-3 text-center">
                ...
                <select id="filter" class="form-control" onchange="window.location.href=this.options[this.selectedIndex].value;">
                    ...
                    <option value="{{ route('treatments.GetFacialTreatmentsAsc') }}" class="text-center" selected>Low to High</option>
                    <option value="{{ route('treatments.GetFacialTreatmentsDesc') }}" class="text-center">High to Low</option>
                </select>
            </div>
        </div>
    </div>
