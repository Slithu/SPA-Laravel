            ...
            <div class="card">
                ...
                <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $type->name }}" disabled>
                            </div>
                        </div>
                        ...
                        <a class="nav-link" href="{{ route('types.index') }}" style="text-align:center">
                            <button class="btn btn-success btn-sm">Return to Type List</button>
                        </a>
                </div>
            </div>
        </div>
